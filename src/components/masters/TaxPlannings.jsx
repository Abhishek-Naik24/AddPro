...
const TaxPlannings = () => {
  ...
  let save = (e) => {
    ...
    if (data.cgst.trim() !== "") {
      if (data.cgst > 100) {
        dataErrors.cgst = "Range Should be from 0.01 to 100";
        validated = false;
      }
    }
    else {
    ...
    if (data.sgst.trim() !== "") {
      if (data.sgst > 100) {
        dataErrors.sgst = "Range Should be from 0.01 to 100";
        validated = false;
      }
    }
    else {
    ...
    if (data.igst.trim() !== "") {
      if (data.igst > 100) {
        dataErrors.igst = "Range Should be from 0.01 to 100";
        validated = false;
      }
    }
    else {
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tax planings</li>
          </ol>
        </nav>
      </div>
              ...
              <div class="card-body">
                <div class="row g-3 p-3">
                  ...
                  <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" id="cgst" placeholder='9%' value={data.cgst} onChange={(e) => { handleChange(e); }} />
                  </div>
                  <div class="col-lg-4">
                    <label class="form-label">SGST*<span class="small text-danger"> {dataError.sgst}</span></label>
                    <input type="text" class="form-control" id="sgst" placeholder='9%' value={data.sgst} onChange={(e) => { handleChange(e); }} />
                  </div>
                  <div class="col-lg-4">
